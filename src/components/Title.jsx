      ...
      <div className="flex flex-wrap  justify-between w-10/12 items-center relative text-[#3d4152] font-medium">
        ...
        <div className="relative mr-5 hidden sm:flex">
          <ul className="flex space-x-9 flex-wrap  justify-center">
            <li className=" ">
              <Link
                className="flex space-x-2 hover:text-orange-500 group items-center h-[80px]"
                to={"/search"}
              >
                <span>
                  <svg
            ...
            <li className="">
              ...
              >
                ...
                <span className=" hidden md:flex">
                  Offers<sup className="text-orange-500 m-1">NEW</sup>
                </span>
              </Link>
            </li>
                ...
                <span className="">
                  ...
                  >
                    ...
                    <text
                      x="10"
                      y="21"
                      className="fill-white text-xl  items-center stroke-orange-500"
                    >
                      {10}
                    </text>
                  </svg>
