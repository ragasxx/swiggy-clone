...
const RestrauntMenu = () => {
  ...
  const categories = resMenu?.data?.cards[
    cardIndex
    ...
    <div className=" w-full mt-9">
      <div className="w-6/12 mx-auto">
        <div className="flex justify-between relative">
          <div>
            <p className="text-[#282c3f] text-[20px] font-semibold leading-tight">
              {name}
            </p>
            <p className="text-[#7e808c] text-[12px] mt-2">
              {cuisines ? cuisines.join(", ") : ""}
            </p>
            <div className="flex items-center">
              <p className="text-[#7e808c] text-[12px]">
          ...
          <div className="border-[1px] box-border rounded-md sm:w-auto">
            ...
            <p className="text-[#8b8d97] text-[11px] font-semibold py-[8px] m-1">
              {totalRatingsString}
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-4 mt-3 text-[#3e4152] text-[15px] font-bold">
          <div className="flex items-center ">
            <svg
              className="hidden sm:flex mr-[10px]"
              width="18"
              height="18"
              viewBox="0 0 18 18"
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="mr-[24px] sm:mr-[12px]">
              {resMenu?.data?.cards[0]?.card?.card?.info?.sla?.slaString}
            </span>
          </div>
          <div className="flex items-center">
            <svg
              className="mr-[10px] hidden sm:flex"
              width="18"
              height="18"
              viewBox="0 0 18 18"
              xmlns="http://www.w3.org/2000/svg"
